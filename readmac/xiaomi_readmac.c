...
const char WLAN_MAC_FILE[] = "/data/vendor/mac_addr/wlan_mac.bin";
const char BT_MAC_FILE[] = "/data/vendor/mac_addr/bt.mac";
...
static int write_bt_mac_file(uint8_t bt_mac[]) {
    FILE *fp;
    ...
    chown(BT_MAC_FILE, AID_SYSTEM, AID_SYSTEM);
